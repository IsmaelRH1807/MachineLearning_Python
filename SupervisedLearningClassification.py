# -*- coding: utf-8 -*-
"""
Created on Mon May 17 00:33:34 2021
...
Data_iris = iris.data  #array
Data_iris = pd.DataFrame(Data_iris, columns = iris.feature_names)  #DataFrame
...
X_train, X_test, y_train, y_test  = train_test_split(x, y, test_size = 0.2, train_size = 0.8,
                                                     ...
                                                     stratify = y) #random_state for save the random instance
